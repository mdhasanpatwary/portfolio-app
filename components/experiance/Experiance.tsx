...
const experiences = [
    {
        ...
        techStack: [<SiReact />, <SiNextdotjs />, <SiTailwindcss />, <FaDocker />],
    },
    {
        company: 'Themelooks',
        role: 'Front-End Developer',
        ...
        techStack: [<FaHtml5 />, <FaCss3Alt />, <SiJquery />, <SiBootstrap />],
    },
];
...
const ProfessionalExperience: React.FC = () => {
    return (
        <section
            id="experience"
            className="w-full py-24 px-6 bg-gradient-to-br from-white via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900"
        >
                ...
                <div className="grid md:grid-cols-2 gap-8 text-left">
                    {experiences.map((exp, index) => (
                        ...
                        >
                            ...
                            <div className="flex gap-3 text-lg text-blue-600 dark:text-blue-400">
