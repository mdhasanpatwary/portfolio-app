  ...
  return loading ? (
    ...
    <Link
      ...
      <div className="flex-1 flex flex-col px-4 md:px-7 py-4 md:py-6">
        ...
        {/* Title */}
        <h2
          className="text-2xl font-serif font-bold text-gray-900 dark:text-white mb-2 line-clamp-2"
          title={post?.title}>
          {post?.title}
        </h2>
        {/* Meta info */}
        ...
        {/* Read more link */}
        <div>
          <span className="text-primary-700 dark:text-primary-400 text-sm font-semibold hover:underline underline-offset-4 cursor-pointer">
            Read more →
          </span>
        </div>
      </div>
