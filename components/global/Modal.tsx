        ...
        {(title || showCloseButton) && (
          <div className="relative p-4 sm:px-8 sm:py-6 border-b border-gray-200/50 dark:border-gray-700/50 bg-gradient-to-r from-gray-50/80 via-white/80 to-gray-50/80 dark:from-gray-800/80 dark:via-gray-900/80 dark:to-gray-800/80 backdrop-blur-sm rounded-t-3xl">
            {showCloseButton && (
              <button
                onClick={onClose}
                className="absolute top-6 right-6 p-2.5 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 transition-all duration-200 rounded-full hover:bg-gray-100/80 dark:hover:bg-gray-800/80 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-primary-500/50">
                <FaTimes size={18} />
              </button>
            )}
            {title && (
