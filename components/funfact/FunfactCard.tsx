      ...
      <div className="relative flex flex-col items-center gap-2 z-10 w-full">
        {Icon ? (
          <Icon
            ...
            style={{
              color:
                brandColors[fact.icon as keyof typeof brandColors] || "#6366F1",
            }}
          />
        ) : null}
        <div className="text-2xl md:text-3xl font-extrabold text-indigo-600 dark:text-indigo-400">
          {fact.value}
        </div>
        <div
