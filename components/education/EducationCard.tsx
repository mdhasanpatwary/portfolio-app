...
const EducationCard: FC<EducationCardProps> = ({ item }) => {
  return (
    <div className="relative">
      ...
      <div className="hidden md:block absolute left-6 top-8 bottom-0 w-0.5 bg-gradient-to-b from-primary-500 to-transparent"></div>
      {/* Timeline dot - hidden on mobile */}
      <div className="hidden md:block absolute left-4 top-6 w-4 h-4 bg-primary-600 rounded-full border-4 border-white dark:border-gray-800 shadow-lg z-10"></div>
      <Card className="md:ml-12" variant="default" padding="md">
        ...
        <div className="flex items-center gap-2 text-xs text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-gray-800 rounded-md px-3 py-1.5 w-fit">
          <FaCalendarAlt className="text-primary-500" aria-hidden="true" focusable="false" />
