...
const Contact: FC = () => {
    ...
    return (
        <section
            id="contact"
            className="w-full py-24 px-6 bg-gradient-to-b from-white via-slate-100 to-white dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 transition-colors duration-300"
        >
